...
public class CommonController {
	...
	@RequestMapping(value = "/configProperty/addConfingProperty/{code}/{value}")
	public @ResponseBody String addConfingProperty(@PathVariable String code, @PathVariable String value)
			throws Exception {
		return stockService.addConfingProperty(code, value);
	}
}
